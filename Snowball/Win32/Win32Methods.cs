...
namespace Snowball.Win32
{
	internal class Win32Methods
	{
		...
		public static extern IntPtr CreateWindowEx(int dwExStyle, string lpClassName, string lpWindowName, uint dwStyle, int x, int y, int nWidth, int nHeight,
												   IntPtr hWndParent, IntPtr hMenu, IntPtr hInstance, IntPtr lpParam);

		[DllImport("user32.dll")]
		public static extern IntPtr DispatchMessage([In] ref Win32Message msg);
		...
		[DllImport("user32.dll")]
		public static extern bool TranslateMessage([In] ref Win32Message msg);
	}
}
